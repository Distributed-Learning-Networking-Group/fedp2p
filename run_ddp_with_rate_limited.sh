...
# 限速
sudo /bin/bash ~/code/communication/rate_limit.sh
...
NCCL_DEBUG=INFO NCCL_SOCKET_IFNAME=enp5s0f1 sudo  ~/code/communication/bt_ps/5.resnet_cifar_ddp.py --rank=$RANK --world_size=3 --master_addr=192.168.124.102 --master_port=$master_port --model=resnet101 --dataset=cifar10 --num_epochs=10 --log_level=INFO --batch_size 512 --lr=0.01
