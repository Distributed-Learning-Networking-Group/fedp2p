...
/home/whr/.conda/envs/bt/bin/python ps.py --rank=$RANK --world_size=4 --master_addr=192.168.124.102 --master_port=$master_port --model=resnet101 --dataset=cifar10 --log_level=INFO --batch_size=512 --num_epochs=100 --lr=0.01